...
class QuadrupleTank():
    def __init__(self, x0, Hmax, voltmax, f=0.5):
        self.x0 = x0
        self.t = 0
...
#cliente = Cliente("opc.tcp://192.168.137.166:4840/freeopcua/server/", suscribir_eventos=True, SubHandler=SubHandler)

# cliente = Cliente("opc.tcp://192.168.1.95:4840/freeopcua/server/", suscribir_eventos=True, SubHandler=SubHandler)
...
while running:
    ...
    if manual:
        ...
        if volt1 > 10 or volt1 < -1 or volt2 > 10 or volt2 < -1 \
